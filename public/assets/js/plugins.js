 ...
 */
! function(e, t, a, l) {
    var n, s, i, o, r, c, u, h, g, f, d, p, _ = "mPageScroll2id",
        C = "mPS2id",
        v = {
            scrollSpeed: 1e3,
            autoScrollSpeed: !0,
        ...
        S = {
            init: function(l) {
                ...
                s.liveSelector && (this.selector += "," + s.liveSelector), n = n ? n + "," + this.selector : this.selector, s.defaultSelector && ("object" == typeof e(n) && 0 !== e(n).length || (n = ".m_PageScroll2id,a[rel~='m_PageScroll2id'],.page-scroll-to-id,a[rel~='page-scroll-to-id'],._ps2id")), s.clickEvents && e(a).undelegate("." + C).delegate(n, "click." + C, function(t) {
                    if (I._isDisabled.call(null)) I._removeClasses.call(null);
                    else {
                        var a = e(this),
                            l = a.attr("href"),
                            n = a.prop("href").baseVal || a.prop("href");
                        l && -1 !== l.indexOf("#/") || (I._reset.call(null), f = a.data("ps2id-offset") || 0, I._isValid.call(null, l, n) && I._findTarget.call(null, l) && (t.preventDefault(), o = "selector", r = a, I._setClasses.call(null, !0), I._scrollTo.call(null)))
                    }
                }), e(t).unbind("." + C).bind("scroll." + C + " resize." + C, function() {
                    if (I._isDisabled.call(null)) I._removeClasses.call(null);
                    else {
                        var t = e("._" + C + "-t");
                        t.each(function(a) {
                ...
                }), i = !0, I._setup.call(null), I._live.call(null)
            },
            scrollTo: function(t, a) {
                if (I._isDisabled.call(null)) I._removeClasses.call(null);
                    ...
                    a = e.extend(!0, {}, l, a);
                    I._reset.call(null), h = a.layout, g = a.offset, t = -1 !== t.indexOf("#") ? t : "#" + t, I._isValid.call(null, t) && I._findTarget.call(null, t) && (o = "scrollTo", (r = a.clicked) && I._setClasses.call(null, !0), I._scrollTo.call(null))
                }
            },
            destroy: function() {
                e(t).unbind("." + C), e(a).undelegate("." + C).removeData(C), e("._" + C + "-t").removeData(C), I._removeClasses.call(null, !0)
            }
        },
        I = {
                ...
                return e(t).each(function() {
                    ...
                    if (I._isValid.call(null, i, o)) {
                        var r = -1 !== i.indexOf("#/") ? i.split("#/")[1] : i.split("#")[1],
                            c = e("#" + r);
                        if (c.length > 0) {
                            s.highlightByNextTarget && c !== l && (l ? l.data(C, {
                                tn: c
                            }) : c.data(C, {
                                tn: "0"
                            }), l = c), c.hasClass("_" + C + "-t") || c.addClass("_" + C + "-t"), c.data(C, {
                                i: a
            ...
            _findHighlight: function(a) {
                var l = t.location,
                    ...
                    s = l.pathname;
                return e("._" + C + "-h[href='#" + a + "'],._" + C + "-h[href='" + n + "#" + a + "'],._" + C + "-h[href='" + s + "#" + a + "'],._" + C + "-h[href='#/" + a + "'],._" + C + "-h[href='" + n + "#/" + a + "'],._" + C + "-h[href='" + s + "#/" + a + "']")
            },
            _setClasses: function(t, a, l) {
                var n = s.clickedClass,
                    i = s.targetClass,
                    o = s.highlightClass;
                t && n && "" !== n ? (e("." + n).removeClass(n), r.addClass(n)) : a && i && "" !== i && l && o && "" !== o && (I._currentTarget.call(null, a) ? (a.addClass(i), l.addClass(o)) : (!s.keepHighlightUntilNext || e("." + o).length > 1) && (a.removeClass(i), l.removeClass(o)))
            },
            _extendClasses: function() {
                var t = s.targetClass,
                    ...
                    r = a + "-first",
                    c = a + "-last";
                e("._" + C + "-t").removeClass(i + " " + o), e("._" + C + "-h").removeClass(r + " " + c), s.forceSingleHighlight ? s.keepHighlightUntilNext && l.length > 1 ? (l.slice(0, 1).removeClass(t), n.slice(0, 1).removeClass(a)) : (l.slice(1).removeClass(t), n.slice(1).removeClass(a)) : (l.slice(0, 1).addClass(i).end().slice(-1).addClass(o), n.slice(0, 1).addClass(r).end().slice(-1).addClass(c))
            },
            _removeClasses: function(t) {
                e("." + s.clickedClass).removeClass(s.clickedClass), e("." + s.targetClass).removeClass(s.targetClass + " " + s.targetClass + "-first " + s.targetClass + "-last"), e("." + s.highlightClass).removeClass(s.highlightClass + " " + s.highlightClass + "-first " + s.highlightClass + "-last"), t && (e("._" + C + "-t").removeClass("_" + C + "-t"), e("._" + C + "-h").removeClass("_" + C + "-h"))
            },
            ...
            _scrollTo: function() {
                ...
                switch (h) {
                    case "horizontal":
                        o != u[1] && (I._callbacks.call(null, "onStart"), a.stop().animate({
                            scrollLeft: u[1]
                        }, l, n).promise().then(function() {
                    ...
                    case "auto":
                        var r;
                        if (i != u[0] || o != u[1])
                            if (I._callbacks.call(null, "onStart"), navigator.userAgent.match(/(iPod|iPhone|iPad|Android)/)) a.stop().animate({
                                pageYOffset: u[0],
                                pageXOffset: u[1]
                            }, {
                                duration: l,
                        ...
                        break;
                    default:
                        i != u[0] && (I._callbacks.call(null, "onStart"), a.stop().animate({
                            scrollTop: u[0]
                        }, l, n).promise().then(function() {
                            I._callbacks.call(null, "onComplete")
                        }))
    ...
    I._easing.call(), e.fn[_] = function(t) {
    ...
    return function(t) {
        ...
        t.exports = function(t, e, n, d, h, y, m) {
            ...
            if (L && (b = f(L.call(new t))) !== Object.prototype && b.next && (c(b, w, !0), r || "function" == typeof b[l] || u(b, l, v)), S && O && "values" !== O.name && (A = !0, x = function() {
                    return O.call(this)
                }), r && !m || !p && !A && _[l] || u(_, l, x), a[e] = x, a[w] = v, h)
                if (g = {
                        values: S ? x : T("values"),
                        keys: y ? x : T("keys"),
                        entries: N
                    }, m)
                    for (E in g) E in _ || i(_, E, g[E]);
        ...
        var r = n(1),
            ...
            J = function(t, e, n) {
                return t === U && J(H, e, n), g(t), e = T(e, !0), g(n), o(F, e) ? (n.enumerable ? (o(t, P) && t[P][e] && (t[P][e] = !1), n = S(n, {
                    enumerable: w(0, !1)
                })) : (o(t, P) || L(t, P, w(1, {})), t[P][e] = !0), B(t, e, n)) : L(t, e, n)
            },
            W = function(t, e) {
                g(t);
                        ...
                        if (e.length > 0)
                            for (var n = function(t) {
                                    ...
                                    if (n.nodeType && 1 === n.nodeType) {
                                        ...
                                        if (n.innerText = "", r.addEventToQueue(r.eventNames.ADD_HTML_TAG_ELEMENT, {
                                                node: n
                                            }), !o.length) return {
                                            v: r
                                        };
        ...
        o(o.S + o.F * !n(76)(function(t) {
            ...
            from: function(t) {
                var e, n, o, l, p = i(t),
                    ...
                    m = 0,
                    g = f(p);
                if (y && (h = r(h, d > 2 ? arguments[2] : void 0, 2)), void 0 == g || v == Array && a(g))
                    for (n = new v(e = s(p.length)); e > m; m++) c(n, m, y ? h(p[m], m) : p[m]);
                else
                    for (l = g.call(p), n = new v; !(o = l.next()).done; m++) c(n, m, y ? u(l, h, [o.value, m], !0) : o.value);
                return n.length = m, n
            }
        })
    }, function(t, e, n) {
        ...
        for (var r = n(41), o = n(17), i = n(9), u = n(1), a = n(7), s = n(16), c = n(0), f = c("iterator"), l = c("toStringTag"), p = s.Array, v = {
            ...
            var y, m = d[h],
                ...
                E = u[m],
                b = E && E.prototype;
            if (b && (b[f] || a(b, f, p), b[l] || a(b, l, m), s[m] = p, g))
